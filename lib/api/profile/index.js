...
export default class ProfileAPI {
  ...
  profile = {
    read: async (username) => {
      const endpoint = `${this.apiProfile}/${username}?_listings=true&_wins=true`;
      return await this.fetchData(endpoint);
    },

    readAll: async () => {
      const endpoint = `${this.apiProfile}?_listings=true&_wins=true`;
      return await this.fetchData(endpoint);
    },
    ...
    readListings: async (username) => {
      const endpoint = `${this.apiProfile}/${username}/listings?_comments=true&_author=true&_reactions=true`;
      return await this.fetchData(endpoint);
    },
